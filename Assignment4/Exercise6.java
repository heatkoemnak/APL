...
public class Exercise6 {
  ...
  public static void main(String[] args) {
    ...
    double shortestDistance = distance(points[p1][0], points[p1][1], points[p1][2], points[p2][0], points[p2][1], points[p2][2]); // Initialize the shortest Distance
  ...
  public static double distance(double x1, double y1, double x2, double y2, double z2, double z1) {
